...
const medals = [
  { type: 'Gold', count: 4, bg: 'bg-amber-500/10 dark:bg-amber-500/15', text: 'text-amber-600 dark:text-amber-400', border: 'border-amber-500/20' },
  { type: 'Silver', count: 2, bg: 'bg-gray-400/10 dark:bg-gray-400/15', text: 'text-gray-500 dark:text-gray-300', border: 'border-gray-400/20' },
  { type: 'Bronze', count: 1, bg: 'bg-orange-600/10 dark:bg-orange-500/15', text: 'text-orange-700 dark:text-orange-400', border: 'border-orange-600/20' },
];
      ...
      <Reveal className="reveal-scale">
        <div className="glass-panel rounded-2xl p-6 md:p-8 border-l-4 border-l-[#D4AF37]">
          ...
          <div className="grid grid-cols-3 gap-4">
            {medals.map(m => (
              <div key={m.type} className={`${m.bg} rounded-xl p-4 text-center border ${m.border}`}>
                <Award size={20} className={`${m.text} mx-auto mb-2`} />
